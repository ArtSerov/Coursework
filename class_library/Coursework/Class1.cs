...
namespace Coursework
{
    ...
    public class Resettlement
    {
        ...
        /*public static void AddAnimalsInComplex(List<Complex> complices)
        {
            Console.WriteLine("******************************");
            Console.WriteLine("Поселите животного в комплекс");
            ...
            int kol_vo = Int32.Parse(Console.ReadLine());
            bool flag=false;
            for (int i = 0; i < complices.Count; i++)
            {
                complices[i].AddAni(animal,kol_vo,ref flag);
                if (flag == true) break;
            }
